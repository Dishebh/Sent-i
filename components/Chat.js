...
class Chat extends Component {
  ...
  componentDidMount() {
    ...
    this.channel = this.pusher.subscribe('Sent-i');
      ...
      this.props.activeUser &&
       <>
        ...
        <div className="border-top border-gray w-100 px-4 d-flex align-items-center bg-light" style={{ "minHeight": 90 }}>
          <textarea className="form-control px-3 py-2" onKeyUp={this.handleKeyUp} placeholder="Enter a chat message" style={{ resize: 'none' }}>
          </textarea>
        </div>
       </>
    );
